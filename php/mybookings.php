...
if(!isset($_SESSION["logged_id"])){
    ...
    echo "<table class='table'>";
        echo "<tr>";
            echo "<th>Check In Date : </th><th>Check Out Date : </th><th>Room Type : </th><th>Number Of Guests : </th><th>Amount Paid : </th>";
        echo "</tr>";
    while($row = mysqli_fetch_assoc($result)){
        echo "<tr>";
        echo "<td>" . $row['check_in']."</td><td>" . $row['check_out']."</td><td>" . $row['room_type']."</td><td>".$row['guest_no']."</td><td>".$row["amount_paid"]."</td>";
        echo "</tr>";
